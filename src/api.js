...
const BACKEND_API = 'https://dealpalbackend.herokuapp.com/api/v1';
...
const LOGIN_URL = 'https://dealpalbackend.herokuapp.com/api/v1/login';
const SIGNUP_URL = 'https://dealpalbackend.herokuapp.com/api/v1/signup';
